...
import FamilyMember, {IFamilyMember} from '../models/FamilyMember.js';
...
// GET family member
export const getFamilyMemberId = async (
...
export const updateFamilyMember = async (
  req: Request<{id: string}, {}, Partial<IFamilyMember>>,
  res: Response,
): Promise<void> => {
  try {
...
export const deleteFamilyMember = async (
  ...
  try {
    const deletedFamilyMember = await FamilyMember.findByIdAndDelete(
      req.params.id,
    );
